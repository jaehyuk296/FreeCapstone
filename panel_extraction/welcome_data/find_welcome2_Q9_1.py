...
# 2. 엑셀 파일을 읽어옵니다.
df = pd.read_excel('../../panel_extraction/welcome_data/welcome_2nd.xlsx')

# --- 저장하고 싶은 폴더 경로를 변수로 지정 ---
output_folder = '../../panel_extraction/welcome_data/welcome_2nd.xlsx/' 
...
job_counts = df['Q9_1'].value_counts()
print("각 답변 인원수:")
print(job_counts)
