...
# --- 3. 데이터 전처리 ('설 선물 선호도' 맞춤) ---
option_map = {
    1: '전통 선물 세트', 2: '실용적인 생필품', 3: '건강식품',
    4: '백화점 상품권/현금', 5: '기타', 6: '선호하는 선물 없음'
}

# '문항1' 열을 숫자형으로 변환 (숫자가 아닌 값은 NaN으로 처리)
df['문항1'] = pd.to_numeric(df['문항1'], errors='coerce')

# '선호선물' 열 생성: 숫자 답변을 텍스트로 변환
